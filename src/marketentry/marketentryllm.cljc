(ns marketentry.marketentryllm
  ...
  the JAM public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "has-ppc-registration?=" (:has-ppc-registration? e)
                        " companies-office-registration-verified?=" (:companies-office-registration-verified? e)
     ...
     :confidence (if (and e
                          (or (not (:requires-ppc-registration? e))
                              (:has-ppc-registration? e))
                          (or (not (:requires-companies-office-registration? e))
                              (:companies-office-registration-verified? e)))
                   0.9 0.3)}))
